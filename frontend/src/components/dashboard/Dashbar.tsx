...
const Dashbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#0f0f14]/90 backdrop-blur-md border-b border-white/5">
      ...
      {/* Mobile dropdown */}
      {open && (
        <div className="sm:hidden bg-[#0f0f14] border-t border-white/5 px-4 pb-4 space-y-1">
          <Link to="/" onClick={() => setOpen(false)} className="block py-2.5 px-3 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 text-sm transition-colors">
            <i className="bi bi-house-door mr-2" />Főoldal
          </Link>
          <Link to="/listings" onClick={() => setOpen(false)} className="block py-2.5 px-3 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 text-sm transition-colors">
            <i className="bi bi-card-list mr-2" />Hirdetések
          </Link>
          <div className="pt-2 border-t border-white/5">
            ...
            <Link to="/profile" onClick={() => setOpen(false)} className="block py-2.5 px-3 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 text-sm transition-colors">
              <i className="bi bi-person mr-2" />Profil
            </Link>
            <button
